...
NVCC      = nvcc
NVCCFLAGS =  -arch=compute_$(CUDAARCH) -use_fast_math  -I ${GS2} ${NETCDF} 
NVCCINCS  = -I ${TACC_CUDA_INC} -I ${SIMPLEDATAIO}/include
NVCCLIBS  = -L ${TACC_CUDA_LIB} -lcufft -L ${SIMPLEDATAIO}/lib -l simpledataio
...
GEO_LIBS=${GS2}/geo/geometry_c_interface.o ${GS2}/geo/geo.a  ${GS2}/utils.a
