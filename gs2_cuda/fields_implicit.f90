...
contains
  ...
  subroutine advance_implicit (istep, NLdens_ky0, NLupar_ky0, NLtpar_ky0, NLtprp_ky0, NLqpar_ky0, NLqprp_ky0)
    use fields_arrays, only: phi, apar, bpar, phinew, aparnew, bparnew
    ...
    complex*8, dimension (naky*ntheta0*2*ntgrid*nspec), intent (in) :: NLdens_ky0, NLupar_ky0, NLtpar_ky0, NLtprp_ky0, NLqpar_ky0, NLqprp_ky0
    ...
    call timeadv (phi, apar, bpar, phinew, aparnew, bparnew, istep, NLdens_ky0, NLupar_ky0, NLtpar_ky0, NLtprp_ky0, NLqpar_ky0, NLqprp_ky0)
    ...
    call timeadv (phi, apar, bpar, phinew, aparnew, bparnew, istep, NLdens_ky0, NLupar_ky0, NLtpar_ky0, NLtprp_ky0, NLqpar_ky0, NLqprp_ky0, diagnostics)
