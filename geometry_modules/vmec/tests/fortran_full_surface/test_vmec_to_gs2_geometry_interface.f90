...
!  character(len=2000) :: vmec_filename = 'equilibria/wout_w7x_standardConfig.nc'
  character(len=2000) :: vmec_filename = 'equilibria/wout_li383_1.4m.nc'
!  character(len=2000) :: vmec_filename = 'equilibria/wout_161s1.nc'
  integer, parameter :: nalpha = 1
  integer, parameter :: nzgrid = 64
  real :: zeta_center = 0.0
  real :: number_of_field_periods_to_include = 0
  real :: desired_normalized_toroidal_flux = 0.2604167d+0
