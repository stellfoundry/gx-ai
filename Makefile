...
namelist_defaults.cu: namelist_defaults.in
	echo "/* Do not edit this file!! It is created automatically from namelist_defaults.in */" > namelist_defaults.cu
	echo "char  default_namelist_string[] = \"\\\\n\\" >> namelist_defaults.cu
	cat namelist_defaults.in | sed -e 's/$$/\\n\\/' | sed -e 's/"/\\"/g' >> namelist_defaults.cu
	echo "\";" >> namelist_defaults.cu
