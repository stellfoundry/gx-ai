/* Code to find q number of coefficients for nth Hermite moment closure as described in Smith's thesis
 *
 * Notes:
 * - Debug printing can be turned on/off by changing DEBUG_MODE to 1 or 0
 * */
